...
if ($level!=3) {
    echo "Anda tidak punya akses pada halaman <br><a href='../index.php'>Klik disini</a> ";
    exit;
}
...
<div class="row no-gutters mt-5" style="height: 850px;">
  ...
  <li class="nav-item">
    <a class="nav-link text-white" href="member_peminjam.php"member_peminjam.php><i>Ingin Meminjam?</i></a> <hr class="bg-secondary">
  </li>
</ul>
    </div>
    <div class="col-md-10 pt-5 p-5">
        ...
        <!--<img class="img" src="tenor.gif"></img> -->
