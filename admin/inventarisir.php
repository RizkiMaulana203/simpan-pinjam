...
<div class="row no-gutters mt-5">
    <div class="col-md-2 bg-dark mt-2 pr-3 pt-3" style="height: 650px;">
  ...
  <li class="nav-item">
    <a class="nav-link text-white" href="pengembalian.php"><i>Detail Pinjaman</i></a> <hr class="bg-secondary">
  </li>
  <li class="nav-item">
    <a class="nav-link text-white" href="inventarisir.php"><i>Inventarisir</i></a>
  </li>
</ul>
    </div>
    <div class="col-md-10 pt-5 p-5">
        <h2><i><b>Inventarisir</b></i></h2><hr>

        <a href="crud_inventaris.php" class="btn btn-info mb-3"><i class="fas fa-user-plus mr-2"></i>Tambah Data Inventaris</a>
  ...
  while ($data = mysqli_fetch_array($sql)){
      ...
      <td><i class="far fa-edit bg-info p-2 text-white rounded" data-toggle="tooltip" title="Edit"></i></td>
      <td><i class="far fa-trash-alt bg-danger p-2 text-white rounded" data-toggle="tooltip" title="Hapus"></i></td>
    </tr>
      <?php 
    }
    ?>
