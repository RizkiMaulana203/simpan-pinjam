...
<div class="row no-gutters mt-5" style="height: 650px;">
  ...
  <li class="nav-item">
    ...
    <div class="col-md-10 pt-5 p-5">
        <h2><i><b>Detail Pinjaman</b></i></h2><hr>
  ...
  $query = "SELECT * FROM peminjaman
            INNER JOIN detail_pinjam ON peminjaman.id_peminjaman = detail_pinjam.id_detail_pinjam";
