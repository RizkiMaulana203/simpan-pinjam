...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="../asset/css/sadmin.css">
...
<div class="row no-gutters mt-5">
  ...
  <li class="nav-item">
    ...
    <div class="col-md-10 pt-5 p-5">
        <h2><i><b>Daftar Anggota</b></i></h2><hr>

         <a href="crud.php" class="btn btn-info mb-3"><i class="fas fa-user-plus mr-2"></i>Tambah Data Anggota</a>
  ...
  <tbody>
    ...
    while($d = mysqli_fetch_array($data)){
      ...
      <td class="text-center"><a href="crud.php" class="far fa-edit bg-info p-2 text-white rounded" data-toggle="tooltip" title="Edit"></a></td>
      <td class="text-center"><a href="crud.php" class="far fa-trash-alt bg-danger p-2 text-white rounded" data-toggle="tooltip" title="Hapus"></a></td>
        </td>
      </tr>
      <?php 
    }
